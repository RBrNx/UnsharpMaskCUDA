...
template <typename T>
__global__ void add_weightedGPU(unsigned char *out, unsigned char *in1, const T alpha, const unsigned char *in2, const T  beta, const T gamma, const unsigned w, const unsigned h, const unsigned nchannels) {
